namespace CryptoCurrencyTracker.Services
{
    public class ApiUrl
    {
        ...
        public static string SingleCoin(int id) => $"https://api.coingecko.com/api/v3/coins/{id}";

        public static string HistoricalChart(int id, int days = 365, string currency = "") => $"https://api.coingecko.com/api/v3/coins/{id}/market_chart?vs_currency={currency}&days={days}";
